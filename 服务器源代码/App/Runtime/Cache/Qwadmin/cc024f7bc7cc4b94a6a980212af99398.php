 ...
 <input type="text" name="temp1" id="temp1" style="height:1px" >
  <input type="password" name="temp2" id="temp2" style="height:1px" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nickname" id="nickname" placeholder="姓名" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
 ...
 <input type="text" name="temp1" id="temp1" style="height:1px" >
  <input type="password" name="temp2" id="temp2" style="height:1px" >
									...
									<div class="form-group">
										...
										<div class="space-4"></div>
                                    <div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-8"> 班级/教师 </label>
										<div class="col-sm-9">
											<input type="text" name="stu_class" id="stu_class" placeholder="班级/教师" class="col-xs-10 col-sm-5" value="<?php echo ($member['stu_class']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
