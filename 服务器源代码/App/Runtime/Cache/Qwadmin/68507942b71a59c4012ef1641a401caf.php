...
<!--     正文开始	1. 搜索  2. 代码-->							  
							<div class="row">
									...
									<form class="form-inline" action="" method="get">
									    <a class="btn btn-info" href="<?php echo U(getcomstr('Ad').'addedit');?>?sheetname=<?php echo ($sheetname); ?>&id=<?php echo ($val['id']); ?>" value="">新增</a>
								...
								<div class="row table-responsive">
									...
									<table class="table table-striped table-bordered ">
										...
										<?php if(is_array($queryarr)): $i = 0; $__LIST__ = $queryarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												<td class="center">
													<input class="uids"  type="checkbox" name="uids[]" value="<?php echo ($val['id']); ?>">
												</td>
												<td class="center col-md-1">
												    <a href= "<?php echo U(getcomstr('Ad').'/addedit?id='.$val['id']); ?>">修改</a><br>
											    </td>

                                                <td style="white-space:nowrap;" class="center lilyth"><a href="<?php echo U(getcomstr('Rwxy',$thisuser).'/echoiddata?id='.$val['id']); ?>"><?php echo ($val['content']); ?></a></td>
