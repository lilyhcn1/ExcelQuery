	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="nav nav-tabs">
				...
				<li >
					<a href="<?php echo U('Ud/sheetindex');?>">管理数据</a>
				</li>		
				<li >
					<a href="<?php echo U('Ud/mysheet');?>">个人数据</a>
				</li>
 ...
 <input type="text" name="temp1" id="temp1" style="height:1px" >
  <input type="password" name="temp2" id="temp2" style="height:1px" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nickname" id="nickname" placeholder="姓名" class="col-xs-10 col-sm-5" value="<?php echo ($member['nickname']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">请填写姓名</span>
											</span>
										</div>
									</div>
									...
									<!--<div class="space-4"></div>-->
									<!--<div class="form-group">-->
									<!--	<label class="col-sm-1 control-label no-padding-right" for="form-field-8"> 学院/部门 </label>-->
									<!--	<div class="col-sm-9">-->
									<!--		<input type="text" name="department" id="department" placeholder="学院/部门" class="col-xs-10 col-sm-5" value="<?php echo ($member['department']); ?>">-->
									<!--		<span class="help-inline col-xs-12 col-sm-7">-->
									<!--			<span class="middle">请勿输错</span>-->
									<!--		</span>-->
									<!--	</div>-->
									<!--</div>	-->
									...
									<!--<div class="space-4"></div>-->
									<!--<div class="form-group">-->
									<!--	<label class="col-sm-1 control-label no-padding-right" for="form-field-8"> 学校 </label>-->
									<!--	<div class="col-sm-9">-->
									<!--		<input type="text" name="school" id="school" placeholder="学校" class="col-xs-10 col-sm-5" value="<?php echo ($member['school']); ?>">-->
									<!--		<span class="help-inline col-xs-12 col-sm-7">-->
									<!--			<span class="middle">请勿输错</span>-->
									<!--		</span>-->
									<!--	</div>-->
									...
									<!--<div class="space-4"></div>-->
									<!--<div class="form-group">-->
									<!--	<label class="col-sm-1 control-label no-padding-right" for="form-field-8"> 上传密码 </label>-->
									<!--	<div class="col-sm-9">-->
									<!--		<input type="text" name="querywrpw" id="querywrpw" placeholder="上传密码" class="col-xs-10 col-sm-5" value="<?php echo ($member['querywrpw']); ?>">-->
									<!--		<span class="help-inline col-xs-12 col-sm-7">-->
									<!--			<span class="middle">请用","进行分隔</span>-->
									<!--		</span>-->
									<!--	</div>-->
