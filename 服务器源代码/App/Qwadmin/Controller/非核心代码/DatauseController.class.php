...
$arrstr=
<<<aaa
{"Type":"GroupMsg","FromQQ":{"UIN":53053067,"Card":"\u8001\u9ec4\u725b","SpecTitle":"","Pos":{"Lo":12,"La":0}},"LogonQQ":762865826,"TimeStamp":{"Recv":1600010616,"Send":1600010616},"FromGroup":{"GIN":467011246,"name":"\u601d\u6e90\u7fa4"},"Msg":{"Req":706,"Random":1396787422,"SubType":134,"AppID":0,"Text":"\u7a0e\u53f7\uff1f","Text_Reply":"","BubbleID":4},"File":{"ID":"","MD5":"","Name":"","Size":17179869184}}
aaa;


// $url=I('get.url');
$constr="数据表名等于台州学院公开信息数据库;查看密码等于CGATY5L562;显示字段等于d1,d3;";
// pr($constr,'constr');
...
QQROT::sendGroupMsg($Group, $ReplyMsg);//给QQ：12345 发好友消息
    ...
    $ReplyMsg="欢迎入群，我是智能小助手。为方便管理，请修改群名片噢。：）";
