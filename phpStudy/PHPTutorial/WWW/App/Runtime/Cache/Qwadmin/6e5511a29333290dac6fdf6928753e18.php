	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="nav nav-tabs">
             ...
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="keyword">关键词</label>
              <div class="col-sm-9">
               <input type="text" name="keyword" id="keyword"  value= "<?php echo isset($id)?$data['keyword']:''; ?> " 
                               placeholder="关键词" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">分号分隔</span>
               </span>
              </div>
             </div>
             <div class="form-group">
              ...
              <div class="col-sm-9">
               <textarea type="text" name="content" id="content"   rows="9"
                               placeholder="内容" class="col-xs-10 col-sm-5" > <?php echo isset($id)?$data['content']:''; ?>   </textarea>
