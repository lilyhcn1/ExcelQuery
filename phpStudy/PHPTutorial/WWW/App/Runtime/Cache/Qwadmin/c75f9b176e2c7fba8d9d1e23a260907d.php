...
<div class="container">
    <div id="legend" class="">
        <legend class=""><a href="<?php echo U('RwxyCom/uniquerydata');?>">刷新查询</a> 输入回车查询</legend>
    </div>
<form class="form-horizontal" role="form" method="get" action="<?php echo U('RwxyCom/uniquerydata');?>" >
...
<div class="form-group">
    ...
    <div class="controls col-xs-5">
        <input type="text" id="classa" name="name" class="form-control "   list="cat">  
          <datalist id="cat">    
              <option value=""></option>
                <?php if(is_array($datalistarr)): $i = 0; $__LIST__ = $datalistarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["name"]); ?>"></option><?php endforeach; endif; else: echo "" ;endif; ?>    
          </datalist>  
    </div>
