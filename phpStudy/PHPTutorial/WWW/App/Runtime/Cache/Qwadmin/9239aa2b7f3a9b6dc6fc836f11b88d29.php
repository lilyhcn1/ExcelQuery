	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="nav nav-tabs">
				...
				<li>
					<a href="http://r34.cc/index.php/Qwadmin/Info/index.html">通知公告</a>
				</li>
				<li >
				<a href="http://r34.cc/index.php/Qwadmin/Info/index.html">已读通知</a>
				</li>
				<li >
				<a href="http://r34.cc/index.php/Qwadmin/Info/index.html">意见反馈</a>
				</li>
...
<!--通知公告部分-->
									   ...
									   <button type="button" class="btn btn-success">已读通知列表</button> 
