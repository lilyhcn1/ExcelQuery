...
<html lang="zh-CN">
	<head>
		...
		<meta name="keywords" content="公共信息平台" />
								...
								<div class="row ">
									...
									<table class="table table-striped table-bordered">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td ><a href= "<?php echo U('addedit');?>?id=<?php echo ($val['id']); ?>">
                                                    <?php echo subtext( strip_tags(str_replace(PHP_EOL, '',$val['title'])) ,35); ?>
                                                    </a> </td>
                                                <td ><?php echo subtext( strip_tags(str_replace(PHP_EOL, '',$val['keyword'])) ,18); ?>
                                                <!--<td ><?php echo subtext( strip_tags(str_replace(PHP_EOL, '',$val['content'])) ,70); ?>-->
                                                                                               
                                                <!--   </td>-->
                                                <!--<td class="center col-xs-1"><?php echo date('m-d',$val['time']).'<br>'.date('Y',$val['time']); ?></td>-->

												<!--<td class="center col-xs-1">-->
												<!--    <a href="<?php echo U('addedit');?>?id=<?php echo ($val['id']); ?>">查/修</a>&nbsp;<br>-->
