...
<div class="form-group">
    ...
    <div class="col-sm-10">
		<select name="showtype" class="form-control col-sm-10" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10 ">
            <textarea type="" class="form-control" rows='6' name="content" placeholder=<?php echo ($contenttip); ?>></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="author" class="col-sm-2 control-label">填写人</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="author" name="author" placeholder="填写人">
    </div>
  </div>
