...
<!--     正文开始	1. 搜索  2. 代码-->							  
							<div class="row">
									...
									<form class="form-inline" action="" method="get">
									    <a class="btn btn-info" href="<?php echo U('addedit');?>?id=<?php echo ($val['id']); ?>" value="">新增</a>
										<input id="alldel" class="btn btn-info" type="button" value="删除">

										<input type="text" name="keyword" class="form-control"  placeholder="通知标题" >
									...
									<table class="table table-striped table-bordered ">
										<thead>
											<tr>
                                                ...
                                                <th style="white-space:nowrap;" class="center ">日期</th>

                                                <th class="center">标题</th>
                                                <th class="center hidden-xs">内容</th>
                                                <!--<th class="center">开始时间</th>-->
                                                <th class="center hidden-xs">创建者</th>
                                                <th class="center hidden-xs">接收者</th>
                                                <th style="white-space:nowrap;" class="center">公告</th>                                                                                                                                     <th style="white-space:nowrap;" class="center">发送</th>
                                                                                                <!--<th style="white-space:nowrap;" class="center">快捷</th>-->
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												...
												<td class="center col-md-1">
												    <a href="<?php echo U('addedit');?>?id=<?php echo ($val['id']); ?>">修改</a><br>
											</td>
                                                <th style="white-space:nowrap;" class="center lilyth"> <?php echo date('m-d',$val['creattime'] ); ?> </th>

                                                <th class="center lilyth col-md-2 "><a href="<?php echo U('Lilynoticeview/toreadpage');?>?id=<?php echo ($val['id']); ?>"><?php echo ($val["title"]); ?></a></th>
                                                <th class="lilyth col-md-6 hidden-xs"><a href="<?php echo U('Lilynoticeview/toreadpage');?>?id=<?php echo ($val['id']); ?>"><?php echo (subtext($val["content"],46)); ?></a></th>

                                                <!--<th class="center lilyth"><?php echo date('Y-m-d H:s:i',$val['start_time'] ); ?></th>-->
                                                
                                                <th class="center lilyth col-md-1 hidden-xs"><?php echo GetName($val['sender'],'user','\n'); ?></th>
                                                <th class="center lilyth  col-md-2 hidden-xs"><?php echo (subtext($val['sendto'],25)); ?></th>
                                                <th class="center lilyth "><?php echo ($val['canview']); ?></th>
                                                                                                <th class="center lilyth col-md-1">	<a  class="center" href="<?php echo U('send/index');?>?id=<?php echo ($val['id']); ?>" style="font:30px">发送<br>页面 </a></th>
   <!--<th class="center lilyth col-md-1">	<a class="center" href="<?php echo U('send/shortcutsend');?>?url=<?php echo U('send/index');?>?id=<?php echo ($val['id']); ?>&filename=<?php echo ($val['title']); ?>" >快捷<br>方式</a></th>                                                                                              									    -->
                                                <!--<th class="center lilyth col-md-1"><?php echo ($val['ip']); ?></th>-->
                                                <!--<th class="center lilyth"><?php echo date('Y-m-d H:s:i',$val['exp_time'] ); ?></th>-->
                                                <!--<th class="center lilyth"><?php echo date('Y-m-d H:s:i',$val['del_time'] ); ?></th>-->
