			...
			<ul class="nav nav-tabs">
				...
				<!--</li>-->
					...
					<div class="page-content">
						...
						<!-- /section:settings.box -->
						<div class="row">
							<div class="col-xs-12" style="padding:0 1% 0 12px">
								<!-- PAGE CONTENT BEGINS -->
<!--     正文开始	1. 搜索  2. 代码-->							  
<!--发送给您的通知部分-->
									<form class="form-inline" action="" method="get">
									   ...
									   <button type="button" onclick="window.open('/index.php/Qwadmin/Lilynoticeview/mynotice')" class="btn btn-success">我的通知列表</button> 
									...
									<table class="table table-striped table-bordered ">
										<thead>
											<tr>
												...
												<!--<th class="center hidden-xs">操作</th>-->

            <!--                                    <th class="center hidden-xs">通知ID</th>-->
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val['read']=='未读') { echo "<tr class='danger'>"; }else{ echo "<tr>"; } ?>

												<td class="center">
													<input class="uids"  type="checkbox" name="uids[]" value="<?php echo ($val['id']); ?>">
												</td>
												<!--<td class="center hidden-xs lilyth"> <a type="button" id="button" name="button" class="btn btn-default notfav" href="<?php echo U('toreadpage');?>?id=<?php echo ($val['id']); ?>" onclick="javascript:this.innerHTML='已读';" >	——		</a></td>-->
			
                                                <!--<th  class="center lilyth hidden-xs"><?php echo ($val['id']); ?></th>-->                   
                                                <!--<td class="center lilyth"><?php echo $val['read'] ?>   </td>-->
                                                <td class="lilyth"><a href="<?php echo U('toreadpage');?>?id=<?php echo ($val['id']); ?>"><?php echo (subtext($val["title"],14)); ?></a></td>


                                                <td class="center col-md-1 lilyth"><?php echo GetName($val['sender'],'user','\n'); ?> </td>
                                                <td class="center col-md-2 lilyth"><?php echo date('m-d',$val['creattime'] ); ?></td>
...
<!--公告   部分-->
									   ...
									   <button type="button" onclick="window.open('/index.php/Qwadmin/Lilynoticeview/annonce')" class="btn btn-success">通知公告列表</button> 
            ...
            <!--                                    <th class="center hidden-xs">通知ID</th>-->
                                                ...
                                                <th class="col-md-1 center">发送者</th>
                                                <th class="col-md-2 center">时间</th>
										...
										<?php if(is_array($list_annonce)): $i = 0; $__LIST__ = $list_annonce;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>

												<!--<td class="center hidden-xs lilyth"> <a type="button" id="button" name="button" class="btn btn-default notfav" href="<?php echo U('toreadpage');?>?id=<?php echo ($val['id']); ?>" onclick="javascript:this.innerHTML='已读';" >	——		</a></td>-->
			
                                                <!--<th  class="center lilyth hidden-xs"><?php echo ($val['id']); ?></th>-->                                   
                                                <!--<td class="center lilyth">  已读                  </td>-->
                                                <td class="lilyth"><a href="<?php echo U('toreadpage');?>?id=<?php echo ($val['id']); ?>"><?php echo (subtext($val["title"],16)); ?></a></td>

                                                <td class="center lilyth col-md-1"><?php echo GetName($val['sender'],'user','\n'); ?> </td>
                                                <td class="center lilyth col-md-2"><?php echo date('m-d',$val['creattime'] ); ?></td>
						...
						<!-- /.col --><!--已读通知部分-->
									   ...
									   <button type="button"  onclick="window.open('/index.php/Qwadmin/Lilynoticeview/haveread')"  class="btn btn-success">已读通知列表</button> 
            ...
            <!--                                    <th class="center hidden-xs">通知ID</th>-->
										...
										<?php if(is_array($list_haveread)): $i = 0; $__LIST__ = $list_haveread;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>

												<!--<td class="center hidden-xs lilyth"> <a type="button" id="button" name="button" class="btn btn-default notfav" href="<?php echo U('toreadpage');?>?id=<?php echo ($val['id']); ?>" onclick="javascript:this.innerHTML='已读';" >	——		</a></td>-->
			
                                                <!--<th  class="center lilyth hidden-xs"><?php echo ($val['id']); ?></th>-->                                   
                                                <!--<td class="center lilyth">  已读                  </td>-->
                                                <td class="lilyth"><a href="<?php echo U('toreadpage');?>?id=<?php echo ($val['notice_id']); ?>"><?php echo (subtext($val["title"],16)); ?></a></td>
