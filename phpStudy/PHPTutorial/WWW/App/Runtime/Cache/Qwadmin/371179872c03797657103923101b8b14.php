		...
		<div class="span12">
			<ul class="nav nav-tabs">
				...
				<!--</li>-->
								...
								<div class="row">
									<form id="form" method="post" action="<?php echo U('del');?>">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												...
												<!--	<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>-->
												<!--		<option <?php if($val['gid'] == $v['id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></option>-->
					...
					<form  class="form-inline" action="<?php echo U('Member/upload');?>" method="post" enctype="multipart/form-data">
					    <a   class="inline" href="<?php echo U('Member/excelExport');?>" class="btn btn-info">导出</a>
					     |<a href="/Uploads/excel/%E7%94%A8%E6%88%B7%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xls">导入模板</a>
                        <label  class="inline" >Excel表格：</label>
