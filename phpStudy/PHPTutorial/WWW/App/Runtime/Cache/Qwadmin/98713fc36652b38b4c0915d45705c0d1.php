						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<form class="form-horizontal" role="form" action="<?php echo U('feedbackupdate');?>" method="post">
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
            <div class="form-group">
              <!--<label class="col-sm-1 control-label no-padding-right" for="sendto"></label>-->
              <div class="col-sm-7">
               <textarea   required name="content" id="content"   
                               placeholder="请填写您的意见、建议及Bug反馈，我将认真对待。也可以直接电话联系老黄牛18857637205，53053067@qq.com。" class="col-xs-12 col-sm-12 " rows="8"  ></textarea>
