...
<!--     正文开始	-->							  
	                            ...
	                            <div class="row">
									<form class="form-inline" action="" method="get">
									   ...
									   <input id="agree" class="btn btn-info" type="button" value="同意">
									   <button type="button" class="btn btn-success">||||</button> 
									   <input id="disagree" class="btn btn-info" type="button" value="不同意">
								...
								<div class="row ">
									...
									<table class="table table-striped table-bordered">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td class="center col-xs-2"><?php echo ($val['showtype']); ?></td>
                                                ...
                                                <td class="center col-xs-6" ><?php echo ($val['content']); ?> </td>
                                                 <td class="center col-xs-3" >
                                                     ...
                                                     <img src="<?php echo ($val['pic']); ?>" class="img-responsive" alt="$val['title']"  height="400"></td></a>
		...
		$(function(){
			...
			$("#agree").click(function(){
				bootbox.confirm({
					...
					callback:function(result){
						if(result){
						    var url= "<?php echo U('showoperate');?>?op=agree";
			...
			$("#disagree").click(function(){
				bootbox.confirm({
					...
					callback:function(result){
						if(result){
						    var url= "<?php echo U('showoperate');?>?op=disagree";
                            $("#form").attr("action", url);
							$("#form").submit();
						}
					},
