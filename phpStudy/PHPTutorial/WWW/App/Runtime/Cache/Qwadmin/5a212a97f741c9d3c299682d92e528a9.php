...
<!--     正文开始	-->							  
  ...
  <form class="form-horizontal " method="post" action="<?php echo U('showupdate');?>" >
    <fieldset>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
		<select name="showtype" id="showtype" class="form-control col-sm-10" >
		    <!--<option><?php echo ($selectdata); ?></option>-->
			<option value="失物招领">失物招领</option>
			<option value="台院消息">台院消息</option>
			<option value="我要表白">我要表白</option>
			<option value="兼职招聘">兼职招聘</option>
			<option value="二手信息">二手信息</option>
  ...
  <div class="form-group">
    <label for="title" class="col-sm-2 control-label">简单标题</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="title" name="title" placeholder="标题（可不填）">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10 ">
            <textarea type="" id='content' class="form-control" rows='6' name="content" placeholder=<?php echo ($contenttip); ?>></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="content" class="col-sm-2 control-label">上传图片</label>
										<div class="col-sm-10">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("pic",100,100);?></div>
...
<script src="/Public/qwadmin/js/bootbox.min.js"></script>
		...
		$(function(){
            ...
            $('#showtype').change(function(){
                switch ( $("#showtype").val() ) {
                        case ("二手信息"):
                         $('#content').attr('placeholder',"二手信息的相关要求\n这里是第二行。"); 
                            break;
                        case ("失物招领"):
                         $('#content').attr('placeholder',"失物招领的相关要求\n这里是第二行。"); 
                            break;
                        case ("台院消息"):
                         $('#content').attr('placeholder',"台院消息的相关要求\n这里是第二行。"); 
                            break;
                        case ("我要表白"):
                         $('#content').attr('placeholder',"我要表白的相关要求\n这里是第二行。"); 
                            break;
                        case ("兼职招聘"):
                         $('#content').attr('placeholder',"兼职招聘的相关要求\n这里是第二行。"); 
                            break; 
                        case ("其它信息"):
                         $('#content').attr('placeholder',"其它信息的相关要求\n这里是第二行。"); 
                            break;     
                        default:
                        break;
                }
