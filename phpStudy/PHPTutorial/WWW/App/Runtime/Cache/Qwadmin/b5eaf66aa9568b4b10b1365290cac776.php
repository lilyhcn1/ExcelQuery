...
<!--     正文开始	-->							  
							<div class="row">
									...
									<form class="form-inline" action="" method="get">
										...
										<input type="text" name="keyword" class="form-control"  placeholder="学号/姓名/长号/短号" >
									...
									<table class="table table-striped table-bordered ">
										<thead>
											<tr>
												...
												<th class="center">家庭电话</th>
												<th class="center">父亲</th>
												<th class="center">父亲工作</th>
												<th class="center">父亲电话</th>
												<th class="center">母亲</th>
												<th class="center">母亲工作</th>
												<th class="center">母亲电话</th>
												<th class="center">手机长号</th>
												<th class="center">短号</th>
												<th class="center">宿舍号</th>
												<th class="center">Q Q</th>
												<th class="center">信仰</th>
												<th class="center">电话</th>
												<th class="center">班级</th>
												<th class="center">学号2</th>
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												...
												<td class="center">
												    <a href="<?php echo U('addedit');?>?id=<?php echo ($val['id']); ?>">修改</a>&nbsp;
												    <a class="del" href="javascript:;" val="<?php echo U('del');?>?uids=<?php echo ($val['id']); ?>" title="删除">删除</a>
												</td>
                                                <td class="center"><?php echo ($val['stuid']); ?></td>
                                                <td class="center"><?php echo ($val['name']); ?></td>
                                                <td class="center"><?php echo ($val['sex']); ?></td>
                                                <td class="center"><?php echo ($val['nation']); ?></td>
                                                <td class="center"><?php echo ($val['cid']); ?></td>
                                                <td class="center"><?php echo ($val['homeaddress']); ?></td>
                                                <td class="center"><?php echo ($val['home_telephone']); ?></td>
                                                <td class="center"><?php echo ($val['father_name']); ?></td>
                                                <td class="center"><?php echo ($val['father_work']); ?></td>
                                                <td class="center"><?php echo ($val['father_phone']); ?></td>
                                                <td class="center"><?php echo ($val['mon_name']); ?></td>
                                                <td class="center"><?php echo ($val['mon_work']); ?></td>
                                                <td class="center"><?php echo ($val['mon_phone']); ?></td>
                                                <td class="center"><?php echo ($val['phone']); ?></td>
                                                <td class="center"><?php echo ($val['s_phone']); ?></td>
                                                <td class="center"><?php echo ($val['room']); ?></td>
                                                <td class="center"><?php echo ($val['QQ']); ?></td>
                                                <td class="center"><?php echo ($val['faith']); ?></td>
                                                <td class="center"><?php echo ($val['telephone']); ?></td>
                                                <td class="center"><?php echo ($val['class']); ?></td>
                                                <td class="center"><?php echo ($val['fdy']); ?></td>
