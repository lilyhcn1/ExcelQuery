...
<!--     正文开始	-->							  
							<div class="row">
									...
									<form class="form-inline" action="" method="get">
										...
										<input type="text" name="keyword" class="form-control"  placeholder="班级/班长/班长短号" >
									...
									<table class="table table-striped table-bordered ">
										<thead>
											<tr>
											   ...
											   <th class="center lilyth">班级</th>
                                                        <th class="center">班级全称</th>
                                                        <th class="center">班长</th>
                                                        <!--<th class="center">班长<br>学号</th>-->
                                                        <th class="center">班长<br>手机长号</th>
                                                        
                                                        <th class="center">班长<br>短号</th>
                                                        <!--<th class="center">团支书<br>学号</th>-->
                                                        <th class="center">团支书</th>
                                                        <th class="center">团支书<br>手机长号</th>
                                                        <th class="center">团支书<br>短号</th>
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
												...
												<td class="center">
												    ...
												    <a class="del" href="javascript:;" val="<?php echo U('del');?>?uids=<?php echo ($val['id']); ?>" title="删除">删除</a>												</td>
                                                    <th class="center lilyth"><?php echo ($val['stuclass']); ?></th>
                                                    <th class="center lilyth"><?php echo ($val['classlong']); ?></th>
                                                    <th class="center lilyth"><?php echo ($val['monitor']); ?></th>
                                                    <!--<th class="center lilyth"><?php echo ($val['monitor_stuid']); ?></th>-->
                                                    <th class="center lilyth"><?php echo ($val['monitor_mphone']); ?></th>
                                                    <th class="center lilyth"><?php echo ($val['monitor_smphone']); ?></th>
                                                    <th class="center lilyth"><?php echo ($val['tuanzhishu']); ?></th>
                                                     <!--<th class="center lilyth"><?php echo ($val['tuanzhishu_stuid']); ?></th>-->
                                                    <th class="center lilyth"><?php echo ($val['tuanzhishu_mphone']); ?></th>
                                                    <th class="center lilyth"><?php echo ($val['tuanzhishu_smphone']); ?></th>
