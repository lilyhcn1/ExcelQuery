...
<!--【注意】这是个人平台，没收人一分钱，因此也没有责任。所以想开我就开，想关我就关，大家高兴就好。---老黄牛-->
  ...
  <!-- 第一个是传值用的 -->
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
               <input type="text" name="user" id="user" minlength="4" required alnum  placeholder="4位及以上且请只使用英文或数字" class="col-xs-10 col-sm-5 " >
               <span class="help-inline col-xs-12 col-sm-7">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
               <input type="text" name="nickname" id="nickname"  required  placeholder="姓名" class="col-xs-10 col-sm-5"   >
               <span class="help-inline col-xs-12 col-sm-7">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
               <input type="text" name="phone" id="phone"  required  placeholder="手机号" class="col-xs-10 col-sm-5"   >
                
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">验证码将发送至手机。</span>
               </span>               
              </div>
             </div>
 ...
 <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="form-field-6">学校</label>
              <div class="col-sm-9">

          <div class="controls">
            <select  name="classa" id="classa" class="input-xlarge form-control">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['school']); ?>"><?php echo ($val['school']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
          </div>
           </div>
    </div>
 ...
 <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="form-field-6">部门</label>
              <div class="col-sm-9">

          <div class="controls">
            <select  name="classb" id="classb" class="input-xlarge form-control">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['department']); ?>"><?php echo ($val['department']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
          </div>
           </div>
    </div>
 ...
 <div class="form-group">
          ...
          <div class="controls">
            <select  name="classc" id="classc" class="input-xlarge form-control">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['stuclass']); ?>"><?php echo ($val['stuclass']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
          </div>
           </div>
    </div>
    ...
    <!--      <div class="controls">-->
    <!--        <select  name="classa" id="classa" class="input-xlarge form-control">-->
    <!--            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>-->
    <!--                <option value="<?php echo ($val['school']); ?>"><?php echo ($val['school']); ?></option>-->
