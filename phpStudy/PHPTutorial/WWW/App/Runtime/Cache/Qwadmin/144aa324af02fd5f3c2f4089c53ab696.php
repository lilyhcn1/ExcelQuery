 ...
 <input type="text" name="temp1" id="temp1" style="height:1px" >
  <input type="password" name="temp2" id="temp2" style="height:1px" >
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 数字ID </label>
										<div class="col-sm-9">
											<input type="text" disabled="disabled" class="rcol-xs-10 col-sm-5" value="<?php echo ($member["uid"]); ?>">
  ...
  <input type="password" name="temp2" id="temp2" style="height:1px" >
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						...
						<small> 本站由<a href="<?php echo (C("site")); ?>" target="_blank"><?php echo (C("footer")); ?></a>制作，并已开源。 </small>
