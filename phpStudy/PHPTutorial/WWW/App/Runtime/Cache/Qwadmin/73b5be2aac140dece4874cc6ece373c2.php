...
<html lang="zh-CN">
	<head>
		...
		<meta charset="utf-8" />
		<title>教师信息查询-<?php echo (C("title")); ?></title>
...
<script src="http://cdn.bootcss.com/bootbox.js/4.4.0/bootbox.js"></script>    		
    ...
    $(document).ready(function(){
        ...
        $("#classb").load("/index.php/Qwadmin/PInfo/teacherclassify",{data:classaval,fc:'department',sc:'name'});

        $("#classa").change(function(){
            var val=$(this).val();
            //alert(val);
            $("#classb").load("/index.php/Qwadmin/PInfo/teacherclassify",{data:val,fc:'department',sc:'name'});
        });
        ...
        //     var val=$(this).val();
        //     //alert(val);
        //     $("#classc").load("/index.php/Qwadmin/PInfo/teacherclassify",{data:val,fc:'class',sc:'name'});
        // });
            //三级分类联动四级分类
        $("#classb").change(function(){
             var val=$(this).val();
            temp=$('#info').load("/index.php/Qwadmin/PInfo/getteacherinfo",{data:val,fc:'name'});
