						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<form class="form-horizontal" role="form" action="<?php echo U('updatesendopt');?>" method="post">
									    
<!--加入这行禁止自动填充-->
<div style="text-indent:-9999px">
 <input type="text" name="temp1" id="temp1" style="height:1px" >
  <input type="password" name="temp2" id="temp2" style="height:1px" >
</div>  
...
<div class="panel panel-info">
  ...
  <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="wxdelay">微信时延</label>
              <div class="col-sm-9">
               <input type="text" name="wxdelay" id="wxdelay"  value= "<?php echo ($data["wxdelay"]); ?>" 
                               placeholder="微信时延" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">-1为不发送，0为即时发送，大于零为时延。</span>
               </span>
              </div>
    </div>   
...
<!--高校通-->
 <div class="panel panel-info">
    ...
    <div class="panel-body">
              <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="gxtdelay">高校通时延</label>
              <div class="col-sm-9">
               <input type="text" name="gxtdelay" id="gxtdelay"  value= "<?php echo ($data["gxtdelay"]); ?>" 
                               placeholder="高校通时延" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">-1为不发送，0为即时发送，大于零为时延。</span>
               </span>
              </div>
             ...
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="gxtid">高校通高校ID</label>
              <div class="col-sm-9">
               <input type="text" name="gxtid" id="gxtid"  value= "<?php echo ($data["gxtid"]); ?>" 
                               placeholder="高校ID" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">台州学院为70</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="gxtuser">高校通用户名</label>
              <div class="col-sm-9">

               <input type="text" name="gxtuser" id="gxtuser"  value= "<?php echo ($data["gxtuser"]); ?>" 
                               placeholder="高校通用户名" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">没有可不填</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="gxtpw">高校通密码</label>
              <div class="col-sm-9">

               <input type="password" name="gxtpw" id="gxtpw"  value= "<?php echo ($data["gxtpw"]); ?>"  autocomplete="off"  placeholder="高校通密码" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
             ...
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="smaildelay">邮件时延</label>
              <div class="col-sm-9">
               <input type="text" name="smaildelay" id="smaildelay"  value= "<?php echo ($data["smaildelay"]); ?>" 
                               placeholder="邮件时延" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">-1为不发送，0为即时发送，大于零为时延。</span>
               </span>
              </div>
             ...
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="smail">邮箱</label>
              <div class="col-sm-9">
               <input type="text" name="smail" id="smail"  value= "<?php echo ($data["smail"]); ?>" 
                               placeholder="邮箱" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">尽量使用163的邮箱</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="smailsmtp">邮箱SMTP服务器</label>
              <div class="col-sm-9">
               <input type="text" name="smailsmtp" id="smailsmtp"  value= "<?php echo ($data["smailsmtp"]); ?>" 
                               placeholder="邮箱SMTP服务器" class="col-xs-10 col-sm-5" >
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">smtp.163.com</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="smailuser">邮箱用户名</label>
              <div class="col-sm-9">
               <input type="password" style="display:none" />
               <input type="text" name="smailuser" id="smailuser"  value= "<?php echo ($data["smailuser"]); ?>" 
                               placeholder="邮箱 用 户 名" class="col-xs-10 col-sm-5" >
                <input type="password" style="display:none" />
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">XXX@163.com</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="smailpw">邮箱密码</label>
              <div class="col-sm-9">
               <input type="password" style="display:none" />
               <input type="password" name="smailpw" id="smailpw"  value= "<?php echo ($data["smailpw"]); ?>" 
                               placeholder="邮箱密码" class="col-xs-10 col-sm-5" >
                               <input type="password" style="display:none" />
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle"></span>
               </span>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
             ...
             <!--    <div class="form-group">-->
             <!-- <label class="col-sm-1 control-label no-padding-right" for="qqgroup">QQ群</label>-->
             <!-- <div class="col-sm-9">-->
             <!--  <input type="text" name="qqgroup" id="qqgroup"  value= "<?php echo ($data["qqgroup"]); ?>" -->
             <!--                  placeholder="QQ群" class="col-xs-10 col-sm-5" >-->
             <!--  <span class="help-inline col-xs-12 col-sm-7">-->
             <!--   <span class="middle">默认的QQ群</span>-->
             <!--  </span>-->
             <!-- </div>-->
             <!--</div>-->
             ...
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="sendto">默认发送组</label>
              <div class="col-sm-9">
               <textarea  name="sendto" id="sendto"   
                               placeholder="接收者" class="col-xs-10 col-sm-5 " rows="3"  ><?php echo ($data["sendto"]); ?></textarea>
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">默认发送的对象,一行一个成员</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="sendto2">群组2</label>
              <div class="col-sm-9">
               <textarea  name="sendto2" id="sendto2"   
                               placeholder="接收者" class="col-xs-10 col-sm-5 " rows="3"  ><?php echo ($data["sendto2"]); ?></textarea>
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">群组2，一行一个成员</span>
               </span>
              </div>
             </div>
 
             <div class="form-group">
              <label class="col-sm-1 control-label no-padding-right" for="sendto3">群组3</label>
              <div class="col-sm-9">
               <textarea  name="sendto3" id="sendto3"   
                               placeholder="接收者" class="col-xs-10 col-sm-5 " rows="3"  ><?php echo ($data["sendto3"]); ?></textarea>
               <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle">群组3，一行一个成员</span>
               </span>
              </div>
             </div>
